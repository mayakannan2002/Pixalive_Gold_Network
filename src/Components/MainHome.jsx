  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 pt-[15px]">
        {/* Header */}
        <header className="py-2 px-4 md:px-12 flex justify-center">
        ...
        <section className="py-16 px-4 md:px-12 flex justify-center text-white">
          <div className="max-w-[1280px] w-full mx-auto flex flex-col md:flex-row items-center justify-between gap-10">
            {/* Left Text */}
            <div className="max-w-xl space-y-6 text-center md:text-left">
              <h1 className="text-4xl md:text-5xl font-bold leading-tight">
                Pixalive Gold Network: <br />
                <span>Trusted Gold, Endless Possibilities</span>
              </h1>
              ...
              <div className="flex flex-col md:flex-row gap-4 justify-center md:justify-start">
                ...
                <button className="flex items-center gap-2 border border-white text-white px-5 py-2 w-full md:w-auto">
                  <img
            ...
            {/* Buy Gold Widget */}
            <div className="bg-white text-black p-6 shadow-lg w-full md:w-96">
              {/* Tabs */}
                      ...
                      <div className="flex justify-between items-center mb-3 text-sm">
                        <div>
                          <p className="text-gray-500 flex items-center gap-1">
                            <span className="w-2 h-2 bg-red-500 inline-block rounded-full"></span> Live Buy Price
                          </p>
