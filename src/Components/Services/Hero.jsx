            ...
            <nav className="hidden md:flex gap-6">
              {navItems.map((item) => (
                <button
                  ...
                  className="text-white text-[16px] border-b-[1px] border-transparent hover:border-white transition-all duration-200 cursor-pointer"
                >
                  {item.name}
                </button>
              ))}
          ...
          <div className="max-w-[1280px] w-full mx-auto flex flex-col md:flex-row items-center justify-between">
            ...
            <div className="max-w-3xl space-y-6 text-center md:text-left">
              <h1 className="text-4xl md:text-5xl font-bold leading-tight">
                ...
                <span>
                  Trade, and Grows with Pixalive Gold
                </span>
              </h1>
              <p className="text-[16px]" style={{ wordSpacing: "0.2em" }}>
                "India’s first social gold platform — offering 100% gold-backed
                investments, instant trading, secure gold loans, chit plans, and
                more. All powered by MMTC-PAMP purity."
              </p>
