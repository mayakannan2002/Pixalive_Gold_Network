...
const Authentication = () => {
  ...
  return (
    <div className="w-full flex justify-center px-4 md:px-0 bg-[#f6f6f6] py-10 max-w-[1580px] mx-auto max-h-[900px]">
      <div className="border-7 border-white shadow-lg  grid md:grid-cols-2 max-w-12xl w-[1500px] bg-white overflow-hidden ">
        {/* Image Section */}
