    ...
    <footer className="bg-black text-white  relative overflow-hidden">
      ...
      <div className="grid grid-cols-1 px-4 sm:px-6 py-10 md:px-12 lg:px-20 md:grid-cols-12 gap-10 z-10 relative">
        ...
        <div className="md:col-span-4 space-y-4">
          ...
          <p className="text-sm mt-10 sm:mt-16 text-[#FFFFFF]">
        ...
        <div className="md:col-span-8 flex flex-col sm:flex-row sm:flex-wrap gap-6 sm:gap-10 md:gap-16 lg:gap-20 md:justify-end">
          ...
          <div className="flex flex-col gap-5 text-base">
            <a href="https://www.linkedin.com/company/pixalive-gold-network/" className="inline-flex items-center space-x-1 hover:underline cursor-pointer">
            <FaLinkedin />
              <span>LinkedIn</span>
              <FaArrowUpRightFromSquare className="text-md" />
              
            </a>
            <a href="https://www.instagram.com/pixalive.gold/" className="inline-flex items-center space-x-1 hover:underline cursor-pointer">
            <FaInstagram />
              <span>Instagram</span>
              <FaArrowUpRightFromSquare className="text-md" />
            </a>
            <a href="https://www.facebook.com/pixalive.gold/" className="inline-flex items-center space-x-1 hover:underline cursor-pointer">
            <FaFacebook />
              <span>Facebook</span>
              <FaArrowUpRightFromSquare className="text-md" />
            </a>
      ...
      {/* Terms & Privacy Links */}
      <div className="flex flex-col px-4 sm:px-6  md:px-12 lg:px-20 sm:flex-row justify-center sm:justify-end mt-8 text-sm text-[#FFFFFF] gap-4 sm:gap-10 md:gap-20">
      ...
      <div className="w-full mt-10 flex justify-center">
        <img
          ...
          className="max-w-[1580px] w-full h-auto object-contain"
        />
      </div>
