...
const PixaliveGoldNetwork = () => {
  return (
    <section className=" px-4 sm:px-6 lg:px-20 py-12 min-h-screen">
      <div className="max-w-screen-xl mx-auto">
        {/* Header section */}
        <div className="flex flex-col lg:flex-row lg:items-start lg:space-x-10 mb-10">
          <div className="lg:w-2/5 mb-6 lg:mb-0">
            <p className="text-base sm:text-base md:text-lg lg:text-xl text-gray-500 font-medium leading-snug">
              Pixalive Gold Network
            </p>
            <p className="text-base sm:text-base md:text-lg lg:text-xl text-black font-medium leading-snug mt-4">
              Bridging Social Engagement and Commerce
            </p>
          </div>
          <div className="lg:w-4/5">
            <p className="text-black text-2xl sm:text-3xl md:text-3xl lg:text-[45px] leading-snug sm:leading-snug md:leading-snug lg:leading-tight font-normal">
        ...
        <div className="mt-19 lg:ml-[35.833333%]">
          <div className="flex flex-col md:flex-row md:space-x-10">
            <div className="md:w-1/2 mb-6 md:mb-0">
              <p className="text-gray-500 text-base sm:text-lg md:text-xl leading-relaxed sm:leading-loose md:leading-loose">
