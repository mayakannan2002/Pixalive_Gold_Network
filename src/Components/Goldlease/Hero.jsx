...
import bgImage from "../../assets/Goldlease/leasebg.png";
        ...
        <div className="py-20 max-w-[1260px] px-4 mx-auto  flex flex-col md:flex-row items-center justify-between">
          ...
          <div className="max-w-3xl space-y-6 text-center md:text-left">
            <h1 className="text-4xl md:text-5xl font-bold leading-tight text-white">
              Invest in Gold. Earn with     <br />
              <span className="text-white"> Confidence.</span>
            </h1>
            <p className="text-[16px] text-white" style={{ wordSpacing: '0.2em' }}>
              Pixalive Gold Lease offers a secure, gold-backed investment program with attractive returns and complete peace of mind. Grow your wealth while we protect your gold.           </p>
